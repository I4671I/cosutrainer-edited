...
{
    {
        ...
        window->user_data((void*)(this));
        {
            ...
            {
                scale_ar = new Fl_Check_Button(210, 248, 170, 22, "Scale AR");
                scale_ar->down_box(FL_DOWN_BOX);
                scale_ar->value(0);
            } // Fl_Check_Button* scale_ar
            {
                scale_od = new Fl_Check_Button(210, 271, 170, 22, "Scale OD");
                scale_od->down_box(FL_DOWN_BOX);
                scale_od->value(0);
            } // Fl_Check_Button* scale_od
            {
                pitch = new Fl_Check_Button(210, 294, 170, 22, "Adjust Pitch");
                pitch->down_box(FL_DOWN_BOX);
            } // Fl_Check_Button* pitch
            {
                nospinner = new Fl_Check_Button(210, 317, 170, 22, "No Spinner");
                nospinner->down_box(FL_DOWN_BOX);
            } // Fl_Check_Button* nospinner
            {
                cv_mapset = new Fl_Check_Button(210, 340, 170, 22, "Convert Mapset");
                cv_mapset->down_box(FL_DOWN_BOX);
            } // Fl_Check_Button* cv_mapset
            {
                rate = new Fl_Round_Button(210, 391, 85, 25, "Rate");
                rate->down_box(FL_ROUND_DOWN_BOX);
                rate->value(1);
            } // Fl_Round_Button* rate
            {
                bpm = new Fl_Round_Button(295, 391, 85, 25, "BPM");
            ...
            } // Fl_Box* difflabel
            {
                ...
                } // Fl_Slider* arslider
                {
                    ...
                    odslider->minimum(-4.4);
                    odslider->maximum(11.1);
                    odslider->step(0.1);
                    odslider->value(5);
            ...
            {
                optioninput = new Fl_Input(210, 365, 170, 22);
                optioninput->align(Fl_Align(FL_ALIGN_CENTER|FL_ALIGN_INSIDE));
            } // Fl_Input* optioninput
            mainbox->end();
        } // Fl_Group* mainbox
        {
